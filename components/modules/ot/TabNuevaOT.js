...
export default function TabNuevaOT({ tenant_id, usuario_id, rol, onCreada }) {
  ...
  function nueva() {
    setCreada(null);
    setForm({
      numero_ot: "", cliente_id: "", equipo_tipo: "", equipo_marca: "",
      equipo_modelo: "", equipo_serie: "", problema_reportado: "", foto_url: "",
    });
    setError("");
  }
      ...
      <div style={{ display: "flex", justifyContent: "center" }}>
        <div className="ui-card" style={{ maxWidth: 460, width: "100%", textAlign: "center" }}>
          <div className="ui-card__body" style={{ padding: 32 }}>
            <div style={{ color: "var(--em)", fontSize: 44, marginBottom: 8 }}>
            ...
            <div style={{ fontSize: 12, color: "var(--sub)", marginBottom: 24 }}>
              Escaneá el QR o enviá el link para hacer seguimiento
            </div>
            ...
            <div style={{ display: "flex", gap: 10, justifyContent: "center", flexWrap: "wrap" }}>
              ...
              <button className="ui-btn ui-btn--secondary" onClick={nueva}>
                Nueva OT
              </button>
              <button className="ui-btn ui-btn--secondary" onClick={onCreada}>
                Ver órdenes
              </button>
            </div>
          </div>
  ...
  return (
    <div style={{ display: "flex", justifyContent: "center" }}>
      <div className="ui-card" style={{ maxWidth: 580, width: "100%" }}>
        ...
        <div className="ui-card__body">
          <form onSubmit={guardar} style={{ display: "flex", flexDirection: "column", gap: 16 }}>
            ...
            <div className="ui-field">
              ...
              <div style={{ display: "flex", gap: 8 }}>
                ...
                <button
                  ...
                  title="Generar número correlativo automáticamente"
                >
            ...
            <div className="ui-field">
              ...
              <input
                className="ui-input"
                placeholder="Ej: Notebook, Celular, Tablet, Impresora…"
                value={form.equipo_tipo}
                onChange={e => setField("equipo_tipo", e.target.value)}
              />
            </div>
            ...
            <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 12 }}>
              <div className="ui-field">
                ...
                <input
                  ...
                  onChange={e => setField("equipo_marca", e.target.value)}
                />
              </div>
              <div className="ui-field">
                ...
                <input
                  ...
                  onChange={e => setField("equipo_modelo", e.target.value)}
                />
              </div>
            </div>
            ...
            <div className="ui-field">
              ...
              <input
                className="ui-input"
                placeholder="Opcional — útil para historial"
                value={form.equipo_serie}
                onChange={e => setField("equipo_serie", e.target.value)}
              />
            </div>
            ...
            <div className="ui-field">
              ...
              <textarea
                className="ui-input"
                rows={3}
                placeholder="Describí el problema tal como lo reporta el cliente"
                value={form.problema_reportado}
                onChange={e => setField("problema_reportado", e.target.value)}
            ...
            <div className="ui-field">
              ...
              <input
                className="ui-input"
                placeholder="https://… (estado del equipo al ingreso)"
                value={form.foto_url}
